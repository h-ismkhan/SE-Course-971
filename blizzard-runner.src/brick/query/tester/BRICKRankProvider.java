...
/* 88 */     String repoName = "log4j";
/* 89 */     String catKey = "NL";
/* 90 */     BRICKRankProvider brickRankProvider = new BRICKRankProvider(repoName, 
/* 91 */       catKey);
/* 92 */     brickRankProvider.collectBRICKRanks();
/* 93 */     System.out.println("Rank collected:" + repoName);
/* 94 */     long end = System.currentTimeMillis();
/* 95 */     System.out.println("Time needed:" + (end - start) / 1000L + " s");
/*    */   }
/*    */ }

/* Location:           G:\_tobedecided\Compressed\BLIZZARD-Replication-Package-ESEC-FSE2018-master\blizzard-runner.jar
 * Qualified Name:     brick.query.tester.BRICKRankProvider
