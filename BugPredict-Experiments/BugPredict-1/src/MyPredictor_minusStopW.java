...
public class MyPredictor_minusStopW implements IPredictor, Serializable {
	/**
	 * 
	 */
	...
	public void addToLearn(String path, Boolean isBuggy) {
		...
		ArrayList<String> alltokens = _code2Tokens.apply(path);
		
		KeyWords_Java kwords = new KeyWords_Java();
		ArrayList<String> tokens = new ArrayList<>();
		for (String key : alltokens)
			if(!kwords.isStopWord(key))
				tokens.add(key);
	...
	public void Merge(MyPredictor_minusStopW other) {
